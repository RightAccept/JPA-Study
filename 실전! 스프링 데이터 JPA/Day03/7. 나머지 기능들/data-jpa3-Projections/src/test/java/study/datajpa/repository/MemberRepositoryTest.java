...
//        List<Member> members = memberRepository.findMemberEntityGraph();
    ...
    public void specBasic() throws Exception {
        ...
        // findAl을 보면 회원 이름 명세(username)와 팀 이름 명세(teamName)를 and로 조합해서 검색 조건으로 사용
    ...
    public void queryByExample() throws Exception {
        ...
        Member member = new Member("m1");   // 도메인 객체를 가지고 검색 조건을 만드는 것
        ...
        // 검색 조건이 되는 객체에 age가 있으면 무시한다, 이게 없으면 검색 조건에 age와 name이 나감
...
//        Example<Member> example = Example.of(member);
    ...
    // Projection 예시
    // 실행되는 SQL 구문 : select m.username from member m where m.username=‘m1’;
    @Test
    public void projections() throws Exception {
        ...
        //when
//        List<UsernameOnly> result =  memberRepository.findProjectionsByUsername("m1");    // Close Projection
//        List<UsernameOnlyDto> result =  memberRepository.findProjectionsByUsername("m1"); // Open Projection
//        List<UsernameOnly> result =  memberRepository.findProjectionsByUsername("m1", UsernameOnly.class);    // 동적 Projection
