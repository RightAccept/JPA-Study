...
//            List<Member> resultList = em.createQuery(cq).getResultList();
            ...
            // 네이티브 SQL
            List resultList = em.createNativeQuery("select MEMBER_ID, city, street, zipcode, name from MEMBER").getResultList();
...
/*
    ...
    ※ 문제는 검색 쿼리 : 나이가 18살 이상인 회원을 모두 검색하고 싶다면?
...
/*
    ...
    ※ JPQL 빌더 역할
    ※ JPA 공식 기능
    ※ 장점 : 오타가 나면 IDLE에서 잡아준다, 동적 쿼리 짜기 좋다
    ※ 단점 : 너무 복잡하고 실용성이 없다
